...
DESKTOP_SECTION = Section(
    ...
    (
        ...
        Category("wayvnc", "WayVNC", "Escritorio remoto recomendado por Tailscale para Hyprland", "Instala WayVNC, crea servicio de usuario, enlaza solo a Tailscale y desactiva Sunshine sin borrar sus datos.", scripts("remote_desktop/install_wayvnc.sh"), install_detector=lambda: command_exists("wayvnc")),
